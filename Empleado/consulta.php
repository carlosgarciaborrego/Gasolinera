        ...
        <div class="cuerpo">
          ...
          <div class="estadoProducto">
            <p>Estado del pedido: <?php echo $estadoPedido ?></p>
          	...
          	<form action='pagarCompra.php' method='post'>
          	<?php echo "<input type='number' name='idC' value=".$_REQUEST["idCompra"]." style='display:none' />"; ?>
            <button type="submit" class="btn btn-primary sep">Pagar Pedido</button>
            <button type="button" onclick="window.location.href='recogerPedidos.php'" class="btn btn-secundary sep2">Volver Atras</button>
           </form>
        </div>
		  </section>
    </div>
