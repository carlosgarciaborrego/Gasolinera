        ...
        <div class="cuerpo">
          ...
          <div class="gridProductos">
            ...
            foreach ($data as $producto){
                ...
                ?>
            <div class="producto">
              <form class="formProducto" action="editarProducto.php" method="post">

                  <input type="number" id="IdProducto" name="IdProducto" value="<?php echo $producto["ID_P"]?>" style="display:none"/>
